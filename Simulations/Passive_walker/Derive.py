...
print(' ')
print(f'b1 = {simplify(b_ss[2,0])}')
print(f'b2 = {simplify(b_ss[3,0])}')
...
print('X_n_hs = np.array([[0], [0], [omega1_n], [omega2_n]])') # [vx_stance vy_stance omega1 omega2]
print('b_hs = np.array([[A_n_hs*X_n_hs], [0], [0]])') # [momentum before footstrike = A_n_hs*X_n_hs v_swing_foot_after_foot_strike = 0 0 
print('A_hs = np.array([[A_n_hs, -J],  [J, np.zeros(2,2)]])')
print('X_hs = A_hs \ b_hs')
print('omega = np.array([[X_hs[2]+X_hs[3]] [-X_hs[3]]])')
print(' ')